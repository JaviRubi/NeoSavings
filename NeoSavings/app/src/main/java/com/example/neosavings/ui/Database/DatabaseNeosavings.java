...
@Database(entities = {Usuario.class, Registro.class, Categoria.class, Presupuesto.class, PagoProgramado.class, Deuda.class, Objetivo.class}, version =2,exportSchema = false)
