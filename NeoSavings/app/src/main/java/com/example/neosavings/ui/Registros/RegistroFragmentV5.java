...
import com.example.neosavings.ui.Deudas.DeudasInfo;
 ...
 */
public class RegistroFragmentV5 extends Fragment implements ItemClickListener {
    ...
    private static DeudasInfo presupuestoInfo;

    /**
     * Mandatory empty constructor for the fragment manager to instantiate the
     * fragment (e.g. upon screen orientation changes).
     */
    public RegistroFragmentV5(){}

    public RegistroFragmentV5(List<Registro> registros, DeudasInfo context) {
    ...
    public static RegistroFragmentV5 newInstance(int columnCount) {
        RegistroFragmentV5 fragment = new RegistroFragmentV5(ListaCuentas,presupuestoInfo);
